...
interface ModalPageForbiddenProps {
    title?: string;
    description?: string;
    isOpen: boolean;
    onClose: () => void;
...
export default function ModalPageForbidden({
    title,
    description,
    isOpen,
    onClose,
    loading
}: Readonly<ModalPageForbiddenProps>) {
                ...
                >
                    <DialogHeader className="w-full h-[300px] flex items-center justify-center">
                        <Lottie
                            ...
                            rendererSettings={{ preserveAspectRatio: 'xMidYMid slice' }}
                        />
                        <DialogTitle className="text-2xl pt-7">Forbidden</DialogTitle>
                    ...
                    <div className="w-full flex justify-center items-center">
                        <Button
                            qa='button-back-modal-forbidden'
                            className="bg-[#FFC71F] hover:bg-yellow-500 text-black font-medium px-8"
                            onClick={() =>
                                // Number(detailUser?.auth_user?.role?.id_role) === 88
                                //     ? 
