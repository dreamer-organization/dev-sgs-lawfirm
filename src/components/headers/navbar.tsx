          ...
          <div className={`flex items-center justify-between transition-all duration-300 ${scrolled ? "py-3" : "py-5"}`}>
            ...
            <nav className="hidden lg:flex items-center gap-10">
              {menus.map((menu) => (
                <button
                  ...
                  className={`group relative font-medium transition-all duration-300 cursor-pointer ${activeSection === menu.section 
                    ? "text-gold-sgs" 
                    : "text-white hover:text-gold-sgs"
                  } after:absolute after:left-0 after:-bottom-2 after:h-0.5 after:bg-gold-sgs after:transition-all after:duration-300 ${activeSection === menu.section 
                    ? "after:w-full" 
            ...
            <div ref={dropdownRef} className="relative hidden lg:flex">
              <motion.button
                ...
                className="flex items-center gap-2 bg-gold-sgs px-6 py-3 font-semibold text-black shadow-lg transition hover:shadow-yellow-400/30 cursor-pointer rounded-md"
              >
                Consultation
                <motion.div
